      ...
      <Container className={`${styles.pageContainer} mt-2`}>
        <Row>
          <Col>
            ...
            <h4>6. Förmedling av juridisk rådgivning</h4>
            <p>
            ...
            <h4>7. Immateriella rättigheter</h4>
            <p>
            ...
            <h4>8. Ändringar av villkoren</h4>
            <p>
            ...
            <h4>9. Tillämplig lag och tvistlösning</h4>
            <p>
